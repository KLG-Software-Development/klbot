...
namespace klbotlib.Modules
{
    public class AnonyVoiceModule : SingleTypeModule<MessagePlain>
    {
        ...
        private readonly Dictionary<long, UserStatus> _userStat = new Dictionary<long, UserStatus>();
        [ModuleStatus(IsHidden = true)]
        private readonly Dictionary<long, long> _targetGroups = new Dictionary<long, long>();
        private const string _url = "https://ai.baidu.com/aidemo";
        private const string _prefix = "data:audio/x-mpeg;base64,";
        private readonly Regex _priReqPat = new Regex(@"^说骚话 (\d{9,11})$");
        private readonly Dictionary<string, string> _perByName = new Dictionary<string, string>
        {
            { "可爱女童", "4103"},
            { "磁性男声", "4003" },
            { "甜美女声", "4119"},
